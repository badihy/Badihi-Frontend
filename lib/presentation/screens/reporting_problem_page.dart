                            ...
                            child: Column(
                              children: [
                                  ...
                                  decoration: ShapeDecoration(
                                    ...
                                    shape: RoundedRectangleBorder(
                                      side: BorderSide(
                                        width: 1,
                                        color: context
                                            .appColors.borderPrimary /* Colors-Border-border-primary */,
                                      ),
                                      borderRadius: BorderRadius.circular(8),
                                    ),
                                    shadows: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    color:
                                        context.appColors.textTertiary /* Colors-Text-text-tertiary-(600) */,
                                    fontSize: 12,
                                    fontWeight: FontWeight.w400,
                                    height: 1.50,
                                  ),
                              ...
                              decoration: ShapeDecoration(
                                ...
                                shape: RoundedRectangleBorder(
                                  side: BorderSide(
                                    width: 1,
                                    color: context
                                        .appColors.borderSecondary /* Colors-Border-border-secondary */,
                                  ),
                                    ...
                                    children: [
                                      SvgPicture.asset(
                                        ...
                                        colorFilter: ColorFilter.mode(
                                            context.appColors.borderPrimary, BlendMode.srcIn),
                                      ),
                                      Positioned(
                                        left: -5,
                                        top: 15,
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              color:
                                                  context.appColors.fgWhite /* Colors-Foreground-fg-white */,
                                              fontSize: 10,
                                              fontFamily: 'Inter',
